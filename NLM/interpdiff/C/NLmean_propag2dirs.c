...
#define FILENAME_RD "/data/ISOTROPIC/NLM/interpdiff/Udiff_spacespacing6.nc"
#define FILENAME_WR "/data/ISOTROPIC/NLM/interpdiff/NLmean_interpdiff_propag2dirs_simpatch0_accumpatch0_searchbox0_tau0100.nc"
...
#define NUM_BLOCKS 4 /* #(1:SCALE_FACTOR_TIME:N_HR) - 1*/
