...
load(PATCHES_FILENAME, 'patches_lf_all','patches_hf_all');
...
% JOINT PATCHES
patches_all = [patches_lf_all; patches_hf_all];
...
clearvars patches_lf_all patches_hf_all;
...
ODL_FILENAME=strcat('/data/ISOTROPIC/dictionary_learning/ideal/space_ratio_03/DICTIONARY_coupleLFHF_K',num2str(params.K,'%.4d'),'_lambda',strrep(num2str(params.lambda,'%.2f'),'.',''),'.mat');
save(ODL_FILENAME,'D_LF','D_HF','CoefMatrix');
