...
%%
% fig2=figure(); 
% set(fig2, 'Position', [400 100 1000 800]);
% set(fig2, 'Color', 'w');
% semilogx(k_3D_HR(2:128),1.5*k_3D_HR(2:128).*E_HR(2:128),'k-','LineWidth',2);
% hold on;
% semilogx(k_3D_HR(2:32),1.5*k_3D_LR(2:32).*E_LR(2:32),'r-','LineWidth',2); 
% 
% plot([32/3,32/3] ,[0,0.45],'b--','LineWidth',2)
% plot([32,32] ,[0,0.05],'b--','LineWidth',2)
% 
% hold off
% xlabel('k'); ylabel('kE');
